...
This is a **living document**: it goes green as build phases P3–P6 land. Today (P0–P2 complete) the
chain-mechanics core is covered; mandate semantics, constraints, linkage, trust-anchoring, and
receipts are explicitly marked pending against their phase.
